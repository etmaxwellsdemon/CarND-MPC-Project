...
For optimization purpose, some constrains was based on the model, which was coded in the 50-134 lines of the `MPC.cpp`, and the state was updated in the 111-115 lines of the `main.cpp`.
...
##Conclusion
As a result, the speed of the self-driving car can reach up to 60mph without drving onto edges or out of the track.
